...
const Menu = () => {
  ...
  return (
    <>
      ...
      <nav ref={menuRef} style={{width:isLgBreakpoint?"300px":isMdBreakpoint?"200px":"100%"}} className={"z-3 bg-white dark:bg-dark-green shadow-xl fixed " + (isMdBreakpoint?" h-screen  ":"")}>
            ...
            <div>
              {
                ...
                <div className='flex justify-between me-5'>
                  ...
                  <button onClick={handleClick} className="my-4 bg-transparent border-0 outline-0">
                    <img src={isHamburgerMenuClicked? theme === "dark"? DarkCloseIcon : LightCloseIcon: theme === "dark" ? DarkHamburgerMenuIcon : LightHamburgerMenuIcon} width="38px" />
                  </button>
                </div>
              }
              ...
              <div>
                {isHamburgerMenuClicked && !isMdBreakpoint || isMdBreakpoint ? 
                    <ul onClick={handleClick}>
                      ...
                      { !isMdBreakpoint ? <li className='flex justify-center mt-4 mb-7'><ThemeButton/></li> : null }
                    </ul>  
                  :
                    null
              }
